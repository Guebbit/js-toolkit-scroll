export { default as scrollClass, type IScrollClassSettings } from "./scrollClass";
export { default as setIntersection, type IIntersectionSettings, activateIntersection, activateIntersectionOnce, } from "./setIntersection";
